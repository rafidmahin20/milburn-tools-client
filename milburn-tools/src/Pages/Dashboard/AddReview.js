...
const AddReview = () => {
    ...
    <div className="flex items-center justify-between">
        <span className="px-3 py-1 text-xs text-blue-800 uppercase bg-blue-200 rounded-full dark:bg-blue-300 dark:text-blue-900">review</span>
    </div>

    <div>
        <h1 className="mt-2 text-lg font-semibold text-gray-800 dark:text-white">Rating: </h1>
        <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">Feedback</p>
    </div>

    <div>

        <div className="flex items-center justify-center mt-4">
            <p className="mr-2 text-gray-800 cursor-pointer dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300">
