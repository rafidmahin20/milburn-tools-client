      ...
      <div className="w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md  mt-20 mb-20">
        <div className="px-6 py-4">
            ...
            <div className="w-full mt-4">
                    <input className="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-500 bg-white border rounded-md  dark:border-gray-600 dark:placeholder-gray-400 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-blue-300" type="name" placeholder="Name" aria-label="Name" name="name"/>
                </div>
                <div className="w-full mt-4">
                ...
                <div className="flex items-center mt-4 justify-center">
                    ...
                    <button className="px-4 py-2 leading-5 text-white transition-colors duration-200 transform bg-gray-700 rounded hover:bg-gray-600 focus:outline-none" type="submit">Create</button>
                </div>
            </form>
        </div>

        <div className="flex items-center justify-center py-4 text-center bg-gray-50 ">
            <p className="text-sm text-gray-600 dark:text-gray-500">Already Have an account? </p>

            <span onClick={navigateToLogin} className="mx-2 text-sm font-bold text-blue-500 dark:text-blue-400 hover:underline">Login</span>
        </div>
